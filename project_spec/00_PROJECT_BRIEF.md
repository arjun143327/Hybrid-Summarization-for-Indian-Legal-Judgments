...
- **Google Colab**: heavy compute — GBR training on full 7,028-doc train set, BART
  inference/fine-tuning, timing benchmarks — if local hardware is insufficient.
  *(Note: Corpus contains 7,128 pairs across range 1–7132, with IDs 299, 2448, 3553, 4799 omitted upstream and 7131, 7132 appended).*
